...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/sysuser?method=add" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
        ...
        <div class="ItemBlockBorder">
          ...
          <%--          <tr>
						...
						<tr>
							<td>职工号</td>
							<td>
								<input type="text" name="number" class="InputStyle" value=""/>*
							</td>
						</tr>
                        <tr>
							<td>专家级别</td>
							<td><input type="text" name="zjjb" class="InputStyle" value=""/> *</td>
						</tr>
						  <tr>
							  <td>专家类别</td>
							  <td><input type="text" name="zjlb" class="InputStyle" value=""/> *</td>
						  </tr>

						<tr>
							<td>备注</td>
							<td><textarea name="bz" class="TextareaStyle"></textarea></td>
						</tr>
